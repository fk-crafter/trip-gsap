...
export default function DesertEditorial() {
  ...
  return (
    <section className="z-50 w-full bg-gradient-to-b from-[#f7d199] via-[#f3b36b] to-[#d87c3a] text-white py-20 transition-all duration-700">
      <div className="text-center px-6">
        ...
        <button
          ...
          className="mt-6 inline-flex items-center gap-2 text-[#4b1e08] hover:text-[#2d1005] transition-all"
        >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p className="text-lg text-[#4b1e08]/70">
                    {dest.description}
                  </p>
                </div>
              </div>
